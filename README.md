...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("KOBEN Hub | BF",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    ...
    Main:AddToggle("Bring Mob[รวมมอน",true,function(value)
        _G.BringMonster = value
    end)

    Main:AddToggle("FastAttack [1]|[ตีเร็ว1]",true,function(value)
...
Main:AddToggle("FastAttack [2]|[ตีเร็ว2]",true,function(value)
...
Main:AddToggle("FastAttack [3]|(ตีเร็ว3)",true,function(value)
	_G.FastAttack = value
end)
coroutine.wrap(function()
    ...
    local SelectWeapona = Main:AddDropdown("Select Weapon|เลือกอาวุธ",WeaponList,function(value)
        _G.SelectWeapon = value
    end)
    
    Main:AddButton("Refresh Weapon|รีอาวุธ",function()
        SelectWeapona:Clear()
        for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do  
    ...
    local AutoFarm = Main:AddToggle("Auto Farm Level(ออโต้ฟาร์มเวล)",_G.AutoFarm,function(value)
        _G.AutoFarm = value
